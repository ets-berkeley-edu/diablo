<template>
  <div
    aria-labelledby="courses-table-ineligible-header"
    role="region"
  >
    <h2 id="courses-table-ineligible-header" class="pt-4 px-4 text-medium-emphasis w-100">
      <button
        v-if="courses.length"
        class="text-left"
        type="button"
        :aria-expanded="showIneligible"
        aria-controls="courses-table-ineligible"
    ...
    <div v-if="showIneligible" class="overflow-x-auto px-md-4 w-100">
