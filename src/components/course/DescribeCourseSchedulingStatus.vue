  ...
  <v-row class="mt-0">
    <v-col class="font-weight-bold">
      ...
      <div v-if="!course.deletedAt && !course.scheduled">
        <span v-if="!course.hasOptedIn && instructors.length" id="notice-opt-out" class="text-error">
        ...
        -->
        <span v-if="course.scheduled && !course.hasOptedIn && instructors.length" id="notice-opt-out-pending-instructors" class="text-error">
