...
# script must be run on the target EC2 instance (eg, diablo-dev).
#
# -------------------------------------------------------------------
...
config_location="s3://diablo-deploy-configs/diablo/${eb_env}.py"
...
echo; echo "Done!"; echo
echo "Restart Diablo to pick up new configs. Have a nice day!"; echo
